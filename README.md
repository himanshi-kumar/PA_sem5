# PA_sem5 - DSA Practice in Java 🚀

Welcome to my Data Structures and Algorithms practice repository in Java! This repository contains my weekly DSA solutions, problem implementations, and notes maintained throughout the semester.
...
| **[Week-04](./Week-04)** | Linear & Binary Search, First/Last Occurrence, Rotated Sorted Array |
| **[Week-05](./Week-05)** | Bubble Sort, Selection Sort, Merge Sort, Dutch National Flag, Merge Sorted Arrays |
| **[Week-06](./Week-06)** | Quick Sort, Subsets Power Set, House Robber, Letter Combinations |
| **[Week-07](./Week-07)** | Head & Tail Recursion, Fibonacci, Substrings, Binary Watch |
...
## 🛠️ How to Run
Compile and run any Java file directly from the command line:
